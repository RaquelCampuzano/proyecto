...
a acciones maliciosas (ataque) originadas de manera local o remota y que afectan al sistema que se desea 
proteger. 
De esa forma, el que ofrece el recurso se queda sin los beneficios que él mismo genera durante un periodo de tiempo. %TODO: Reescribir.Esta última frase es muy confusa.  
