...
\section{Estructura de \redborderddos}
...
respectivamente, y los enviará hacia \redborderddos. %TODO Frase confusa: ¿qué dos tipos de paquetes se clonan?
...
previo al bloqueo, ya que de otra forma será imposible detectar el momento en el que el ataque ha sido detenido. %TODO Frase muy confusa
...
rendimiento que las basadas en hardware \cite{LucaDeriPFRING}. %TODO estaría bien destacar esta definición con comillas o alguna marca similar que denote que es una cita.
