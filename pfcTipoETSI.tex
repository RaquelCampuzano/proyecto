...
\newacronym[type=main]{PFRING}{PF\_RING}{Protocol Family RING}
...
\hypersetup
	...
	pdfauthor={\elautor},
	pdftitle={\elnombretrabajo, \eltitulo}, 
...
%
\include{CapituloDDoS/CapituloDDoS}
%
\include{CapituloCusum/CapituloCusum}
%
\include{CapituloEstructura/CapituloEstructura}
%
%\include{CapituloPF_RING/CapituloPF_RING}
%
% Cita para las pruebas:     {What gets measured, gets managed.}{Peter Drucker}
% 
...
\cleardoublepage
\phantomsection
\addcontentsline{toc}{listasb}{Glosario}
\chaptermark{Glosario}
