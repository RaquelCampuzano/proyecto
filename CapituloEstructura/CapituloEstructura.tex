...
algoritmo \gls{CUSUM} visto en el capítulo \CHAP{Algoritmo CUSUM}. Sin embargo, para manejar y ser capaz de 
...
\section{Estructura interna}\LABSEC{EsctructuraGeneral}
...
\begin{flalign*}
  &\begin{cases}
    ...
    \text{Memoria no alineada $\rightarrow$} \\
    \text{Región crítica}\\
    \quad\text{Zona de memoria que puede ser modificada por dos hilos}\\
    \text{Variables cerrojo}\\
    \quad\text{Protegen regiones críticas}
